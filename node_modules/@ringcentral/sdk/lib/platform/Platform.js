...
var Platform = /** @class */ (function (_super) {
    ...
    Platform.prototype.loginUrl = function (_a) {
        ...
        if (usePKCE) {
            ...
            query.code_challenge = crypto_1.createHash('sha256')
    ...
    Platform.prototype._generateCodeVerifier = function () {
        var codeVerifier = crypto_1.randomBytes(32);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.delay(this._refreshDelayMs)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, utils_1.delay(retryAfter)];
                    case 6:
                        _a.sent();
