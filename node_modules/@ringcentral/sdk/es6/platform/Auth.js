...
var Auth = /** @class */ (function () {
    ...
    Auth.prototype.setData = function (newData) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var data, refreshTokenExpireTime;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._cache.setItem(this._cacheId, __assign({}, data, newData, { expire_time: Date.now() + parseInt(newData.expires_in, 10) * 1000, refresh_token_expire_time: refreshTokenExpireTime }))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
